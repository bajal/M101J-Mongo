...
public class BlogPostDAO {
    ...
    public List<Document> findByDateDescending(int limit) {
        ...
        List<Document> posts = postsCollection.find().sort(new Document("_id", -1)).limit(limit).into(new ArrayList());;
    ...
    public void addPostComment(final String name, final String email, final String body,
        ...
        List<Document> comments = (ArrayList) post.get("comments");
        Document newComment = new Document();
        newComment.append("author", name).append("email", email).append("body", body);
